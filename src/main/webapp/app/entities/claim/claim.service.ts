...
export class ClaimService {
    ...
    private resourceUrl =  SERVER_API_URL + 'microservice/api/claims';
    ...
    private convertItemFromServer(claim: Claim): Claim {
        ...
        copy.accidentDate = this.dateUtils
            .convertLocalDateFromServer(claim.accidentDate);
        copy.accidentTime = this.dateUtils
            .convertDateTimeFromServer(claim.accidentTime);
        return copy;
    }
    ...
    private convert(claim: Claim): Claim {
        const copy: Claim = Object.assign({}, claim);
        copy.accidentDate = this.dateUtils
            .convertLocalDateToServer(claim.accidentDate);

        copy.accidentTime = this.dateUtils.toDate(claim.accidentTime);
        return copy;
    }
}
